from asyncio.windows_events import NULL # permite usar los NULLs
import sqlite3  as sq3 # importa la libreria que maneja la base de datos

con = sq3.connect('mi_bbdd.db') # conexion a la bd con argumento el nombre del archivo
cur = con.cursor()

# ''' permite escribir la instrucción en varios renglones (no está comentando en este caso)
...
con.commit() # ejecuta los cambios en la bd
con.close()
